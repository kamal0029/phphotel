...
$dbname = "product";
   ...
   $aadhar_number = $_POST['a_numb'];
   $phone_number = $_POST['ph_no'];
   $room_no = $_POST['r_no'];
     if($customer_name == "" || $aadhar_number == "" || $phone_number == ""){
  ...
  $sql = "insert into product_details(customer_name,aadhar_number,phone_number,room_no) values('".$customer_name."', '".$aadhar_number."', '".$phone_number."','".$room_no."')";
